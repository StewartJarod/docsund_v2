...
class ManifestsControllerTest < ActionController::TestCase
  ...
  test "should create manifest" do
    assert_difference('Manifest.count') do
      post :create, manifest: { counter_party: @manifest.counter_party, document: @manifest.document, party: @manifest.party, title: @manifest.title }
    end
  ...
  test "should update manifest" do
    patch :update, id: @manifest, manifest: { counter_party: @manifest.counter_party, document: @manifest.document, party: @manifest.party, title: @manifest.title }
    assert_redirected_to manifest_path(assigns(:manifest))
  end
